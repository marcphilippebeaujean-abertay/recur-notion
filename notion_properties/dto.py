...
from .constants import NOTION_SELECT_PROPERTIES, EMPTY_OPTION_DICT, NOTION_TEXT_PROPERTIES_SET, \
...
class NotionPropertyDto:
    def __init__(self, id_str, notion_type_str, name_str, assign_default_value, options_list=None, value=None):
        self.name = name_str
        self.id = id_str
    ...
    def from_notion_api_property_dict(cls, notion_api_property_dict, property_name_str):
        ...
        if notion_property_value == dict() or \
                hasattr(notion_property_value, '__iter__') and 'options' in notion_property_value or \
                hasattr(notion_property_value, '__iter__') and 'format' in notion_property_value:
            options_list = None
            ...
            return cls(id_str=notion_api_property_dict['id'],

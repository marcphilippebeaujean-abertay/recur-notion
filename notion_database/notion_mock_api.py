    ...
    "results": [
        ...
        },
        {
            ...
            "title": [
                {
                    "type": "text",
                    "text": {"content": "Expenses", "link": None},
                    "annotations": {
                        "bold": False,
                        "italic": False,
                        "strikethrough": False,
        ...
        },
        {
            ...
            "title": [
                {
                    "type": "text",
                    "text": {"content": "Habit Tracker", "link": None},
                    "annotations": {
                        "bold": False,
                        "italic": False,
                        "strikethrough": False,
        ...
        },
        {
            ...
            "title": [
                {
                    "type": "text",
                    "text": {"content": "Upcoming Videos", "link": None},
                    "annotations": {
                        "bold": False,
                        "italic": False,
                        "strikethrough": False,
        ...
        },
        {
            ...
            "title": [
                {
                    "type": "text",
                    "text": {"content": "Trip Dubai", "link": None},
                    "annotations": {
                        "bold": False,
                        "italic": False,
                        "strikethrough": False,
            ...
            "properties": {
                "Zeit": {"id": "ME%3DX", "name": "Zeit", "type": "date", "date": {}},
                "Status": {
                    "id": "%5BpM%40",
                    "name": "Status",
                    "type": "select",
                    "select": {
                        "options": [
                            ...
                            {"id": "2", "name": "Gebucht", "color": "yellow"},
                            {"id": "3", "name": "Completed", "color": "green"},
                        ]
                    },
                },
        ...
        },
        {
            ...
            "title": [
                {
                    "type": "text",
                    "text": {"content": "Competition", "link": None},
                    "annotations": {
                        "bold": False,
                        "italic": False,
                        "strikethrough": False,
        ...
        },
        {
            ...
            "title": [
                {
                    "type": "text",
                    "text": {"content": "Brand Tasks", "link": None},
                    "annotations": {
                        "bold": False,
                        "italic": False,
                        "strikethrough": False,
...
def create_or_get_mocked_oauth_notion_client(*args, **kwargs):
    ...
    class MockClient:
        ...
        def client_token_is_valid(self):
            return (
                self.token == VALID_ACCESS_TOKEN or self.token == VALID_ACCESS_TOKEN_2
            )

        @property
        def databases(self):
            self.database_api_mock = MockDatabasesApi(
                is_valid_token=self.client_token_is_valid
            )

...
from notion_properties.service import get_list_of_property_dtos_from_notion_database_resp_dict
...
def convert_notion_database_resp_dict_to_simple_database_dict(notion_db_dict):
    return {
        ...
        'properties': get_list_of_property_dtos_from_notion_database_resp_dict(notion_db_dict=notion_db_dict)
    }

...
from .views import recurring_tasks_view, create_recurring_task, delete_recurring_task, get_recurring_tasks_for_user, get_notion_workspace_tasks, update_recurring_task


urlpatterns = [
    path('create-recurring-task/', create_recurring_task, name='create-recurring-task'),
    path('get-recurring-task/', get_recurring_tasks_for_user, name='get-recurring-tasks'),
